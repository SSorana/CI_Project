...
class Maze:
    ...
    def add_pheromone_route(self, route, q):
        ...
        for r in route.get_route():
            ...
            self.walls[coordinate.get_x()][coordinate.get_y()] += pheromone
    ...
    def evaporate(self, rho):
        for x in range(self.width):
            for y in range(self.length):
                if self.walls[x][y] != 0:
                    self.walls[x][y] = (1 - rho) * self.walls[x][y]
    ...
    def get_surrounding_pheromone(self, position):
        return SurroundingPheromone.get_total_surrounding_pheromone(position)
    ...
    def get_pheromone(self, pos):
        if (self.in_bounds(pos)):
            return self.walls[pos.get_x()][pos.get_y()]
        else:
            return 0
